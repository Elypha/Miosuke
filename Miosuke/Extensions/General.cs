...
public static class FloatArrayExtensions
{
    public static Vector2 ToVector2(this float[] source)
    {
        ...
        if (source.Length < 2)
            throw new ArgumentException("The source array must contain at least 2 elements.", nameof(source));
    ...
    public static Vector3 ToVector3(this float[] source)
    {
        ArgumentNullException.ThrowIfNull(source);
        if (source.Length < 3)
            throw new ArgumentException("The source array must contain at least 3 elements.", nameof(source));
    ...
    public static Vector4 ToVector4(this float[] source)
    {
        ArgumentNullException.ThrowIfNull(source);
        if (source.Length < 4)
            throw new ArgumentException("The source array must contain at least 4 elements.", nameof(source));
